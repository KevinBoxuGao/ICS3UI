...
def announceGameResult( cheatingFound1, cheatingFound2, score1, score2, roundNum ):
    ...
    if summary == "draw":
        ties = ties + 1
    elif summary == strat1Name:
        strat1Wins = strat1Wins + 1
    elif summary == strat2Name:
        strat2Wins = strat2Wins + 1
...
print(strat1Name + " Won "+str(strat1Wins) + " games")
print(strat2Name + " Won "+str(strat2Wins) + " games")
print(str(ties)+ " draws")
